...
export default function ServiceCardItem({
  ...
  return (
    <div className=" bg-[var(--card-background)] rounded-2xl p-5 text-center flex flex-col items-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-[var(--border-color)]">
      ...
      <button
        className="service-btn w-full bg-[#eef2ff]  text-[var(--color-primary-600)]  font-semibold py-2 px-4 rounded-lg text-sm hover:bg-[var(--color-primary-100)] dark:hover:bg-[var(--color-primary-700)] transition cursor-pointer"
        onClick={onClick}
      >
        Buyurtma
      </button>
