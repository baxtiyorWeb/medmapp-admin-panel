...
export default function PatientDetails({
  ...
  const currentOperator: string = "Operator #1"; // Simulating operator name
  const [selectedPatientId, setSelectedPatientId] = useState(null);
  if (!patient) return null;

  const canEdit =
    patient.createdBy === currentOperator || currentOperator === "Admin";
      ...
      if (cardType === "personal") {
        return {
          ...
          details: {
            ...p.details,
            passport: (
              document.getElementById("edit-passport") as HTMLInputElement
            ).value,
            dob: (document.getElementById("edit-dob") as HTMLInputElement)
              .value,
            gender: (
              document.getElementById("edit-gender") as HTMLSelectElement
            ).value,
        ...
        return {
          ...
          details: {
            ...p.details,
            complaints: (
              document.getElementById("edit-complaints") as HTMLInputElement
            ).value,
            previousDiagnosis: (
              document.getElementById("edit-diagnosis") as HTMLInputElement
            ).value,
          },
        };
      }
  ...
  return (
    <div
      className="offcanvas offcanvas-end offcanvas-details show"
    ...
    >
      ...
      <div className="offcanvas-body">
          ...
          <div className="details-card-body" id="personal-details-body">
            {editMode === "personal" ? (
              <>
                <div className="details-info-item">
                  ...
                  <input
                    ...
                    id="edit-passport"
                    defaultValue={patient.details.passport}
                  />
                </div>
                <div className="details-info-item">
                  ...
                  <input
                    ...
                    className="form-control form-control-sm"
                    id="edit-dob"
                    defaultValue={patient.details.dob}
                  />
                </div>
                <div className="details-info-item">
                  ...
                  <select
                    ...
                    id="edit-gender"
                    defaultValue={patient.details.gender}
                  >
              ...
              <>
                <div className="details-info-item">
                  <span className="label">Pasport</span>
                  <span className="value">{patient.details.passport}</span>
                </div>
                <div className="details-info-item">
                  <span className="label">Tug&apos;ilgan sana</span>
                  <span className="value">{patient.details.dob}</span>
                </div>
                <div className="details-info-item">
                  <span className="label">Jins</span>
                  <span className="value">{patient.details.gender}</span>
                </div>
                <div className="details-info-item">
                  <span className="label">Telefon</span>
                  <span className="value">{patient.details.phone}</span>
                </div>
                <div className="details-info-item">
                  <span className="label">Pochta</span>
                  <span className="value">{patient.details.email}</span>
                </div>
              </>
            )}
          </div>
        ...
        <div className="details-card">
          <div className="details-card-header">
            <h6>
              <i className="bi bi-heart-pulse mr-2"></i>Tibbiy ma&apos;lumotlar
            </h6>
          ...
          <div className="details-card-body" id="medical-details-body">
            {editMode === "medical" ? (
              <>
                <div className="details-info-item">
                  ...
                  <input
                    ...
                    className="form-control form-control-sm"
                    id="edit-complaints"
                    defaultValue={patient.details.complaints}
                  />
                </div>
                <div className="details-info-item">
                  ...
                  <input
                    ...
                    className="form-control form-control-sm"
                    id="edit-diagnosis"
                    defaultValue={patient.details.previousDiagnosis}
                  />
                </div>
                <div className="mt-2">
                  <button
                    className="btn btn-sm btn-success border-0"
                    onClick={() => saveDetails("medical")}
                  >
                    <i className="bi bi-check-lg"></i> Saqlash
                  </button>
                  <button
              ...
              <>
                <div className="details-info-item">
                  <span className="label">Shikoyatlar</span>
                  <span className="value">{patient.details.complaints}</span>
                </div>
                <div className="details-info-item">
                  <span className="label">Avvalgi tashxis</span>
                  <span className="value">
                    {patient.details.previousDiagnosis}
                  </span>
                </div>
              </>
            )}
        ...
        <div className="details-card">
          <div className="details-card-header">
            <h6>
              <i className="bi bi-file-earmark-arrow-up mr-2"></i>Yuklangan
              hujjatlar
            </h6>
          </div>
        ...
        <div className="details-card">
          <div className="details-card-header">
            <h6>
              <i className="bi bi-tag mr-2"></i>Holat
            </h6>
          </div>
          <div className="details-card-body">
            <select
        ...
        <div className="details-card">
          <div className="details-card-header">
            <h6>
              <i className="bi bi-clock-history mr-2"></i>Tarix va Izohlar
            </h6>
          </div>
          <div className="details-card-body">
            {patient.history
